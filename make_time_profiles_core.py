...
def main(clouds):
        """
    Read the output from the cloud-tracking algorithm and process the 
    enrainment-related variables from SAM for each individual cloud at 
    every model altitude, or in (ids, height). 
    ...
    Returns
    ----------
    Times profiles in ./cdf/ for core entrainment variables.
    """
